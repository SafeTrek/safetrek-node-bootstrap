...
},{"hammerjs":1,"jquery":2}],4:[function(require,module,exports){
'use strict';
...
(0, _jquery2.default)(function () {
  ...
  var SAFETREK_API_URL = 'https://api-sandbox.safetrek.io/v1/alarms';
  var DEFAULT_ACCURACY = 5;
  var RANDOM_ADDRESS_DATA = '/address-us-100.min.json';
  ...
  if (state.get('authorization_code')) {
    ...
    (0, _jquery2.default)('a.safetrek-btn > img').attr('src', '/assets/images/safetrek-disconnect-button.png');
    (0, _jquery2.default)('input#authorization_code').val(state.get('authorization_code'));
    (0, _jquery2.default)('input#access_token').val(state.get('access_token'));
    (0, _jquery2.default)('input#refresh_token').val(state.get('refresh_token'));
  } else {
    logWarn('SafeTrek is not connected! Current State:\n', state);
  }

  // Prevent changing code and token field values
  (0, _jquery2.default)('input.display-only').on('blur', function () {
    (0, _jquery2.default)(this).val(state.get((0, _jquery2.default)(this).attr('id')));
  });

  // Disconnect from SafeTrek. Clear all data and reload page.
  (0, _jquery2.default)('a.safetrek-btn').on('click', function (e) {
  ...
  (0, _jquery2.default)('.new-token').on('click', function () {
    var that = (0, _jquery2.default)(this);
    that.prop('disabled', true);
    var url = CALLBACK_URL + '?refresh_token=' + state.get('refresh_token');
    _jquery2.default.ajax({
      url: url,
      dataType: 'json',
      success: function success(data) {
        setState('access_token', data.access_token, true);
        (0, _jquery2.default)('input#access_token').val(data.access_token);
      },
  ...
  (0, _jquery2.default)('a.make-alarm-request').on('click', function (e) {
    e.preventDefault();
    if (state.get('status') === 'active-alarm') {
      ...
      if (state.get('access_token')) {
        (0, _jquery2.default)('.alarm').removeClass('alarm-red');
        (0, _jquery2.default)('.alarm-status').text('Requesting...');
        state.set('status', 'processing');
        var url = SAFETREK_API_URL;
        var data = (0, _jquery2.default)('code.alarm-request').text();
        ...
        _jquery2.default.ajax({
          ...
          success: function success(data) {
            ...
            (0, _jquery2.default)('.alarm').addClass('alarm-red');
            (0, _jquery2.default)('.alarm-status').text('Alarm created! Check console for JSON response.');
          },
          error: function error(xhr, status, err) {
            logErr('Error:', err);
          },
          complete: function complete() {
            ...
            setTimeout(function () {
              state.set('status', 'connected');
              (0, _jquery2.default)('.alarm').removeClass('alarm-red');
              (0, _jquery2.default)('.alarm-status').text('');
  ...
  (0, _jquery2.default)('.use-addr').on('click', function (e) {
    e.preventDefault();
    var that = (0, _jquery2.default)(this);
    _jquery2.default.getJSON(RANDOM_ADDRESS_DATA, function (data) {
      ...
      (0, _jquery2.default)('code.alarm-request').text(JSON.stringify(responseJSON, null, 2));
      that.addClass('hide');
      (0, _jquery2.default)('.use-coords').removeClass('hide');
      log('Using random location address.');
    });
  });

  (0, _jquery2.default)('.use-coords').on('click', function (e) {
    e.preventDefault();
    var that = (0, _jquery2.default)(this);
    _jquery2.default.getJSON(RANDOM_ADDRESS_DATA, function (data) {
      var addresses = data.addresses;
      ...
      (0, _jquery2.default)('code.alarm-request').text(JSON.stringify(responseJSON, null, 2));
      that.addClass('hide');
      (0, _jquery2.default)('.use-addr').removeClass('hide');
